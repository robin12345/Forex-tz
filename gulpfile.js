...
var path = {
    ...
    src: { //Пути откуда брать исходники
        ...
        img: 'src/img/tpl/**/*.*', //Синтаксис img/**/*.* означает - взять все файлы всех расширений из папки и из вложенных каталогов
...
//Запуск проекта через вебсервер (http://localhost:9000/) + моментальная отрисовка в браузере
